...
<body>
    ...
    <div class="news_news__information">
                    ...
                    <div class="time-post d-none">
                        <span class="icon posted">
                            <span class="text bold">
                                <i class="fa fa-user">&nbsp;</i></span> | <span class="text">21/11/2022                            </span>
                        </span> 
                    </div>
                    <div class="article-content clearfix">
                        <div class="rte">
                                                        <p style="display: none;">
</p><div class="section-block section-service section_image_text bg-green-dark has-bg">
    <div class="container">
        <div class="section_image_text__inner">
            <div class="row m-0">
...
<script>
    window.addEventListener('DOMContentLoaded', (event) => {
        if($(window).width() > 992){
            $(".section-service__background img").css("height",$(".section_image_text__text").outerHeight());
        }        
    });
</script><p style="display: none;"></p>
<p style="display: none;">            </p><div class="section-block section-service section_gallery bg-green">
            <div class="container">
